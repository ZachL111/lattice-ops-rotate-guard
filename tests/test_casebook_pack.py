"""Regression checks for the lattice-ops-rotate-guard casebook."""
...
from casebook.harness import assert_expected, lattice_ops_rotate_guard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lattice_ops_rotate_guard_summary(), assert_expected())
